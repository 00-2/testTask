...
type
  ...
  procedure findAndWriteP(var SG:TStringGrid; var F:fileOfCars);
...
implementation
 ...
 c:car;
 begin
    n:=strtoint(inputbox('title','Введите мин стоимость','140'));
    m:=strtoint(inputbox('title','Введите макс стоимость','999'));
    power:=strtoint(inputbox('title','Введите мощность','200'));
    Reset(F);
